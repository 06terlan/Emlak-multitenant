                ...
                <div class="x_content">
                    ...
                    <form autocomplete="off" class="form-horizontal form-label-left" novalidate=""  method="post" action="{{ route('msk_makler_add_edit', ['makler' => $id]) }}">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input required="" data-inputmask="'mask' : '(999) 999-9999'" name="mobnom" data-validate-length-range="14,14" type="text" class="form-control" placeholder="Mobil" value="{{ $makler['mobnom'] }}">
                            </div>
                        </div>
