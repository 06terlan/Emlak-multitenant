                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                                <div class="offer offer-radius {!! $announcement['owner_type'] == 1 ? 'offer-primary' : '' !!}">
                                    ...
                                    <div class="offer-content">
                                         ...
                                         <div class="row">
                                             <div class="col-sm-12"  style="font-weight: 700; color: red; font-size: 15px;height: 44px">{{ str_limit($announcement->city->name . '/' . $announcement->place, 50) }}</div>
                                         </div>
                                        <ul class="text-left" style="padding-left: 15px;">
                                            <li><p style="font-weight: 600;">{{ str_limit($announcement->owner, 20) }}</p></li>
