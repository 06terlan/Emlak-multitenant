...

{
    ...
    */
    ...
    [
        1 => ['Gənclik m.', '/g(e|a|ə)nclik/iu'],
        2 => ['Ulduz m.', '/ulduz/iu'],
        3 => ['Həzi Aslanov m.', '/aslanov/iu'],
        4 => ['Elmlər Akademiyası m.', '/elml(ə|a|e)r/iu'],
        5 => ['Nizami m.', '/nizami/iu'],
        6 => ['Şah İsmayıl Xətai m.', '/x(e|a|ə)tai/iu'],
        7 => ['İçəri Şəhər m.', '/[iİ][cç][əea]ri[şs][əae]h[əae]r/iu'],
        8 => ['Sahil m.', '/sahil/iu'],
        9 => ['Koroğlu m.', '/koro[ğg]lu/iu'],
        10 => ['20 Yanvar m.', '/20[ ]*yanvar/iu'],
        11 => ['Əhmədli m.', '/[əae]hm[əae]dli/iu'],
        12 => ['Qara Qarayev m.', '/qarayev/iu'],
        13 => ['Neftçilər m.', '/neft?[çc]il[əae]r/iu'],
        14 => ['Xalqlar Dostluğu m.', '/xalqlar/iu'],
        15 => ['Memar Əcəmi m.', '/[əae]c[əae]mi/iu'],
        16 => ['Azadlıq Prospekti m.', '/azadl[ıi]q/iu'],
        17 => ['Nəsimi m.', '/n[əae]simi/iu'],
        18 => ['Dərnəgül m.', '/d[əae]rn[əae]g[üu]l/iu'],
        19 => ['Cəfər Cabbarlı m.', '/cabbarl[ıi]/iu'],
        20 => ['Bakmil m.', '/bakmil/iu'],
        21 => ['İnşaatçılar m.', '/[İi]n[şs]h?aa?t[çc][ıi]lar/iu'],
        22 => ['28 May m.', '/28[ ]*may/iu'],
        23 => ['Avtovağzal m.', '/avtova[ğg]zal/iu'],
        24 => ['Nəriman Nərimanov m.', '/n(ə|a|e)rimanov/iu'],
    ];
}
