...

{
    ...
    */
    ...
    [
        ...
        6 => ['Qaradağ r.', '', ['city'=>4]],
        7 => ['Nərimanov r.', '', ['city'=>4]],
        8 => ['Nəsimi r.', '', ['city'=>4]],
        9 => ['Nizami r.', '', ['city'=>4]],
        10 => ['Ordubad r.', '', ['city'=>4]],
        11 => ['Pirallahı r.', '', ['city'=>4]],
        12 => ['Sabunçu r.', '', ['city'=>4]],
        13 => ['Səbail r.', '', ['city'=>4]],
        14 => ['Sədərək r.', '', ['city'=>4]],
        15 => ['Suraxanı r.', '', ['city'=>4]],
        16 => ['Şahbuz r.', '', ['city'=>4]],
        17 => ['Yasamal r.', '', ['city'=>4]],
    ...
    [
        ...
        ["Beşmərtəbə   ", '/(be[şs]h?m[əea]rt[əae]b[əae])/iu'],
        ["Binə ticarət mərkəzi", '/(bin[əe][\w ]+ticar[əea]t)/iu'],
        ["Botanika bağı  ", '/(botanika[\w ]+ba[ğgq][ıi])|(ботаническим[\w ]+садом)/iu'],
        ["Bridge Plaza", '/(bridge[ ]+plaza)|(бридж[ ]+плаза)/iu'],
        ["C.Cabbarlı heykəli", '/(cabbarl[ıi][ ]+heyk[əae]li)/iu'],
        ["Caspian Plaza", ""],
